...
\usepackage[left=35mm, right=35mm, top=55mm, bottom=35mm]{geometry}%Seitenränder anpassen
...
\begin{figure}[!h]
   ...
   \setlength\fboxsep{0pt}
   \setlength\fboxrule{0pt}
   \fbox{\includegraphics[trim=0.1cm -1cm -0.5cm 0.9cm, width=1\textwidth]{var8_plot_all_HP_until2008.pdf}}
...
\begin{figure}[!h]
   ...
   \setlength\fboxsep{0pt}
   \setlength\fboxrule{0pt}
   \fbox{\includegraphics[trim=0.1cm -1cm -0.5cm 0.9cm, width=1\textwidth]{var8_plot_all_NoHP_until2008.pdf}}
