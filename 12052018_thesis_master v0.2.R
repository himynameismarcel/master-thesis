...
# the macro unceratinty series and financial uncertainty series 
...
comparison_measures <- as_tibble(comparison_measures[c(2, 8, 4, 5, 1)])
...
# financial uncertainty measure or ludvigson et al (2018)
# at this stage (we only include it for the summary statistics)
